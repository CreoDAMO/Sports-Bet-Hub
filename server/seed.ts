...
export async function seedGames() {
  ...
  const seedData: InsertGame[] = [
    ...
    },
    {
      ...
      underOdds: -110,
      featured: true,
      homeStats: { kills: 12, deaths: 8, damage: 45000, objectives: 3, integrityAlert: false },
      awayStats: { kills: 8, deaths: 12, damage: 38000, objectives: 1, integrityAlert: false },
    },
    {
      sport: "esports",
      league: "CS2",
